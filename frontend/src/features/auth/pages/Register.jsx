          ...
          >
            ...
            <div className="text-center mb-4">
              ...
              <p style={{ fontSize: "12px", color: "#9b8f79" }}>
                Join <span style={{ color: "#EAB308", fontWeight: "600" }}>eStore</span> fashion platform today
              </p>
            </div>
            ...
            <form className="space-y-3" onSubmit={handleSubmit} noValidate>
              ...
              {/* isSeller Toggle Box */}
              <div
                className="flex items-center justify-between p-3 rounded-lg border backdrop-blur-md"
                style={{
              ...
              >
                <div>
                  <label
                    htmlFor="isSeller"
                    className="text-[11px] font-semibold cursor-pointer text-white block"
                  >
                    Register as a Seller
                  </label>
                  <p style={{ fontSize: "9.5px", color: "#9b8f79" }}>
                    List and sell clothing on eStore
                  </p>
                </div>
                {/* Pill Toggle Switch */}
                <button
                  ...
                  className={`w-7 h-4 flex items-center rounded-full p-0.5 transition-colors duration-300 ${formData.isSeller ? "bg-[#EAB308]" : "bg-[#2d2d2d]"
                    }`}
                >
                  <div
                    className={`bg-white w-3 h-3 rounded-full shadow-md transform transition-transform duration-300 ${formData.isSeller ? "translate-x-3 bg-[#111111]" : "translate-x-0"
                      }`}
                  />
                </button>
              </div>

              {/* Create Account Button (Gradient + Arrow) */}
              <button
                type="submit"
                className="w-full py-2.5 px-3 rounded-lg font-bold text-xs transition-all duration-300 flex items-center justify-center gap-2 text-[#111111] shadow-lg shadow-[#EAB308]/15 mt-1"
                style={{
              ...
              <button
                type="button"
                className="w-full py-2 px-3 rounded-lg font-medium text-[11px] text-white border border-[#2e2e2e] transition-all duration-200 flex items-center justify-center gap-2"
                style={{ backgroundColor: "rgba(19, 19, 19, 0.9)" }}
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "rgba(30, 30, 30, 0.9)")}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "rgba(19, 19, 19, 0.9)")}
              >
